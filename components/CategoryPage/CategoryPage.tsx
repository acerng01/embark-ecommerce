...
const CategoryPage: React.FC<CategoryPageProps> = ({products, banner}) => {
  ...
  return (
    <section className='flex flex-col items-center mt-12 font-Outfit'>
        <img src={banner.image} className='relative w-full h-[160px] md:h-[450px] object-cover' alt="Category banner" />
        <p className='text-[3rem] md:text-[6rem] top-[20%] md:top-[40%] font-normal absolute text-white'>{banner.title}</p>
        <div className="w-full flex flex-col items-center md:grid md:grid-cols-4">
